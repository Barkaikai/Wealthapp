...
export default function Guide() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-xl sm:text-2xl font-bold tracking-tight mb-2" data-testid="text-page-title">User Guide</h1>
        <p className="text-xs sm:text-sm text-muted-foreground">Everything you need to master the platform</p>
      </div>
      ...
      <Card className="p-8 bg-gradient-to-br from-primary/5 to-primary/10 border-primary/20">
        <div className="text-center">
          <h3 className="text-base sm:text-lg font-semibold mb-3">Need Personalized Help?</h3>
