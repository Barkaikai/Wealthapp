  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold tracking-tight mb-2" data-testid="text-page-title">Notepad</h1>
          <p className="text-xs sm:text-sm text-muted-foreground">Organize your notes and documents</p>
        </div>
